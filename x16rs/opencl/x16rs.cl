...
X16RS_HASH_FN void hash_x16rs_func_2(hash_32* ALIGN_PARAM hash, OCL_LOCAL_PTR const ulong* ALIGN_PARAM T0, OCL_LOCAL_PTR const ulong* ALIGN_PARAM T1, OCL_LOCAL_PTR const ulong* ALIGN_PARAM T2, OCL_LOCAL_PTR const ulong* ALIGN_PARAM T3)
{
  ...
  H[2] = G[2]  ^ PC64(2  << 4, 0);
  H[3] = G[3]  ^ PC64(3  << 4, 0);
  G[0] = (GROESTL_T0(T0, B64_0(H[0])) ^ GROESTL_T1(T1, B64_1(H[1])) ^ GROESTL_T2(T2, B64_2(H[2])) ^ GROESTL_T3(T3, B64_3(H[3])) ^ 11945401302657479319);
  G[1] = (GROESTL_T0(T0, B64_0(H[1])) ^ GROESTL_T1(T1, B64_1(H[2])) ^ GROESTL_T2(T2, B64_2(H[3])) ^ 5864639994750408448);
  G[2] = (GROESTL_T0(T0, B64_0(H[2])) ^ GROESTL_T1(T1, B64_1(H[3])) ^ 14310125096367509925);
  G[3] = (GROESTL_T0(T0, B64_0(H[3])) ^ 7133757133233952611);
  G[4] = 3669252037894537041;
  G[5] = (230739945414771191 ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T3(T3, B64_7(H[0]))));
  G[6] = (2210698400969090538 ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T3(T3, B64_7(H[1]))));
  G[7] = (519542093484052467 ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T3(T3, B64_7(H[2]))));
  G[8] = (2633073143201150672 ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T3(T3, B64_7(H[3]))));
  G[9] = 14954345047970975975;
  G[10] = (OCL_AS_ULONG_UINT2_S10(GROESTL_T2(T2, B64_6(H[0]))) ^ 10015259800346600524);
  G[11] = (OCL_AS_ULONG_UINT2_S10(GROESTL_T1(T1, B64_5(H[0]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T2(T2, B64_6(H[1]))) ^ 8126327043163178471);
  G[12] = (OCL_AS_ULONG_UINT2_S10(GROESTL_T0(T0, B64_4(H[0]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T1(T1, B64_5(H[1]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T2(T2, B64_6(H[2]))) ^ 8058591818875624105);
  G[13] = (GROESTL_T3(T3, B64_3(H[0]))  ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T0(T0, B64_4(H[1]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T1(T1, B64_5(H[2]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T2(T2, B64_6(H[3]))) ^ 1456122202456506289);
  G[14] = (GROESTL_T2(T2, B64_2(H[0])) ^ GROESTL_T3(T3, B64_3(H[1]))  ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T0(T0, B64_4(H[2]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T1(T1, B64_5(H[3]))) ^ 9849160040520025817);
  G[15] = (GROESTL_T1(T1, B64_1(H[0])) ^ GROESTL_T2(T2, B64_2(H[1])) ^ GROESTL_T3(T3, B64_3(H[2]))  ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T0(T0, B64_4(H[3]))) ^ 269551315503033440);
  ...
  M[0] = (GROESTL_T0(T0, B64_0(H[1])) ^ GROESTL_T1(T1, B64_1(H[3])) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T0(T0, B64_4(H[0]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T1(T1, B64_5(H[2]))) ^ 15705510229074032155);
  M[1] = (GROESTL_T0(T0, B64_0(H[2])) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T0(T0, B64_4(H[1]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T1(T1, B64_5(H[3]))) ^ 12170560161315398722);
  M[2] = (GROESTL_T0(T0, B64_0(H[3])) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T0(T0, B64_4(H[2]))) ^ 13825302525975853362);
  M[3] = (OCL_AS_ULONG_UINT2_S10(GROESTL_T0(T0, B64_4(H[3]))) ^ 17601400094414895344);
  M[4] = 10633925005790587395;
  M[5] = (GROESTL_T3(T3, B64_3(H[0])) ^ 5422291237815970993);
  M[6] = (GROESTL_T3(T3, B64_3(H[1])) ^ 12882214474931762256);
  M[7] = (GROESTL_T3(T3, B64_3(H[2])) ^ 8216379176195919723);
  M[8] = (GROESTL_T3(T3, B64_3(H[3])) ^ 14102764044196225910);
  M[9] = 6583109234331108644;
  M[10] = (1591459941175030872 ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T3(T3, B64_7(H[0]))));
  M[11] = (GROESTL_T2(T2, B64_2(H[0])) ^ 5645326093933893730 ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T3(T3, B64_7(H[1]))));
  M[12] = (GROESTL_T2(T2, B64_2(H[1])) ^ 3203209520027427372 ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T2(T2, B64_6(H[0]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T3(T3, B64_7(H[2]))));
  M[13] = (GROESTL_T1(T1, B64_1(H[0])) ^ GROESTL_T2(T2, B64_2(H[2])) ^ 1597748913811508736 ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T2(T2, B64_6(H[1]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T3(T3, B64_7(H[3]))));
  M[14] = (GROESTL_T1(T1, B64_1(H[1])) ^ GROESTL_T2(T2, B64_2(H[3])) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T1(T1, B64_5(H[0]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T2(T2, B64_6(H[2]))) ^ 5214724303542560770);
  M[15] = (GROESTL_T0(T0, B64_0(H[0])) ^ GROESTL_T1(T1, B64_1(H[2])) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T1(T1, B64_5(H[1]))) ^ OCL_AS_ULONG_UINT2_S10(GROESTL_T2(T2, B64_6(H[3]))) ^ 16053254594141210712);

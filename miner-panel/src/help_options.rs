...
static EN: &[HelpSection] = &[
    HelpSection {
        ...
        lines: &[
            ...
            "Connect — solo fullnode host:port or pool RPC address.",
    ...
    HelpSection {
        title: "[gpu] section (poworker & diaworker)",
        lines: &[
            "use_opencl — true = OpenCL GPU mining (AMD & NVIDIA; no CUDA).",
    ...
    HelpSection {
        ...
        lines: &[
            ...
            "max_temp_c — throttle to throttle_work_groups above this temp (0 = off).",
            "throttle_work_groups — work_groups when thermally throttled (default 1024).",
...
static EL: &[HelpSection] = &[
    HelpSection {
        ...
        lines: &[
            ...
            "Connect — solo fullnode host:port ή pool RPC.",
    ...
    HelpSection {
        title: "[gpu] (poworker & diaworker)",
        lines: &[
            "use_opencl — true = GPU mining με OpenCL (AMD & NVIDIA· όχι CUDA).",
    ...
    HelpSection {
        ...
        lines: &[
            ...
            "max_temp_c — throttle σε throttle_work_groups πάνω από αυτή τη θερμοκρ. (0 = off).",
            "throttle_work_groups — work_groups όταν γίνεται throttle (default 1024).",
